		...
		<!-- Header -->
			<section id="header">
				...
				<footer>
					...
					<li><a href="mailto:snshirol@ncsu.edu" target="_blank" class="icon solid alt fa-envelope"><span class="label">Email</span></a></li>
                    <li><a href="https://www.linkedin.com/in/shivanishirolkar/" target="_blank" class="icon brands alt fa-linkedin"><span class="label">LinkedIn</span></a></li>
                    <li><a href="https://twitter.com/sshirolkar_" target="_blank" class="icon brands alt fa-twitter"><span class="label">Twitter</span></a></li>
					</ul>
				</footer>
			</section>
					...
					<div id="main">
						...
						<!-- Two -->
							<section id="two">
								<div class="container">
									<h3>Experience</h3>
                                    <p>I started getting my feet wet in research in my junior year (October 2018) as an undergraduate assistant. Primarily, 
								...
								<div class="container">
									...
									<div class="features">
										<article>
											...
											<div>
												<p><a href = "http://chrisparnin.me/pdf/Debugging-Hiring.pdf" target="_blank"><strong>Debugging Hiring: What Went Right and What Went Wrong in the Technical Interview Process</strong></a><br/>
                                                Mahnaz Behroozi, Shivani Shirolkar, Titus Barik, Chris Parnin<br/>
                                                <em>ICSE 2020: 42nd ACM/IEEE International Conference on Software Engineering (SEIS Track)</em><br/>
                                                We identify when otherwise qualified candidates get lost in a leaky hiring pipelines.</p>
											</div>
										</article>
                                        <article>
											<!-- <a href="#" class="image"><img src="images/pic01.jpg" alt="" /></a> -->
											<div>
												<p><a href = "http://chrisparnin.me/pdf/stress_FSE_20.pdf"><strong>Does Stress Impact Technical Interview Performance?</strong></a><br/>
                                                Mahnaz Behroozi, Shivani Shirolkar, Titus Barik, Chris Parnin<br/>
                                                <em>FSE 2020: 28th ACM Joint European Software Engineering Conference and Symposium on the Foundations of Software Engineering</em><br/>
                                                Yes.</p>
											</div>
										</article>
									</div>
								...
								<div class="container">
									...
									<div class="features">
										<article>
											<!-- <a href="#" class="image"><img src="images/pic01.jpg" alt="" /></a> -->
											<div>
												<p><a href = "https://news.ncsu.edu/2020/07/tech-job-interviews-anxiety/" target="_blank"><strong>Tech Sector Job Interviews Assess Anxiety, Not Software Skills</strong></a></p>
											</div>
										</article>
									</div>
								</div>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
				...
				<!-- Footer -->
					<section id="footer">
						<div class="container">
							<ul class="copyright">
								<li>&copy;   Shivani Shirolkar 2020</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
							</ul>
						</div>
					</section>
